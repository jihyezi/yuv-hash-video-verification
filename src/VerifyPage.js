...
import "./App.css";
import GalleryModal from "./GalleryModal"; // ✅ 추가

export default function VerifyPage() {
  const [originalImage, setOriginalImage] = useState(null);
  const [suspiciousImage, setSuspiciousImage] = useState(null);
  const [showGallery, setShowGallery] = useState(false); // ✅ 변수명 소문자로
      ...
      <div className="verify-steps">
        ...
        <div className="step-box">
          ...
          <div className="upload-box">
            ...
            {/* ✅ 모달 */}
            <GalleryModal isOpen={showGallery} onClose={() => setShowGallery(false)} onSelect={(image) => {setOriginalImage(image); setShowGallery(false);}}/>
          </div>
        </div>
        ...
        <div className="step-box">
          ...
          <div className="upload-box">
            ...
            <button
              className={`verify-btn ${!originalImage || !suspiciousImage ? "disabled" : ""}`}
